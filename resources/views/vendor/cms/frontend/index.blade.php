...
@section('content')
	@if ($page->slug === 'planning-process')
		<div class="max-w-6xl mx-auto flex justify-end py-4">
			<a href="https://ffo.biz-diagnostic.com" target="_blank">Proactive Planning Platform <i class="fas fa-external-link ml-2"></i></a>
		</div>
	@endif
