...
CropAvatar.prototype = {
  ...
  addListener: function () {
    ...
    this.$avatarModal.on('hidden.bs.modal', $.proxy(this.cancel, this));
  },
  ...
  stopCropper: function () {
    if (this.active) {
      ...
      this.$img.remove();
      this.$avatarWrapper.addClass('default').append('<img src="/vendor/takeoffdesigngroup/cms/assets/global/img/noimage.gif" alt="" />');
      this.active = false;
