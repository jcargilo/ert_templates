...
return [
    ...
    */
    'user_models' => [
        'users' => 'TakeoffDesignGroup\CMS\Models\Auth\User',
    ],
    ...
    */
    'models' => [
         ...
         * Role model
         */
        'role' => 'TakeoffDesignGroup\CMS\Models\Auth\Role',

        /**
         * Permission model
         */
        'permission' => 'TakeoffDesignGroup\CMS\Models\Auth\Permission',

        /**
         * Team model
         */
        'team' => 'TakeoffDesignGroup\CMS\Models\Auth\Team',
